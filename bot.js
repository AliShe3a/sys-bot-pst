...
const devs = ['335737301172879361'];
const db = require('quick.db');
const premium = ['335737301172879361']
...
client.on('message', message => {
    if(message.content == '^vip-servers') {
             if(!message.author.id === '335737301172879361') return;
    var gimg;
    var gname;
    var gmemb;
    var gbots;
...
if (message.author.id !== '335737301172879361') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
client.user.setGame(argresult);
